...
const Skill_Test = () => {
  ...
  const fetchCandidate = async () => {
    setLoading(true);
    try {
      const res = await post(`/api/skill_test/all1`);
      console.log(res);
      if (res) {
        setCandate(res.data);
        setPaginations({
  ...
  return (
    <div className="lg:mt-10 mt-2">
      <div className="flex justify-between items-center ">
        <div className="">
          <h2 className="font-bold text-[24px] ">Test Complete Candidates</h2>
        </div>
      </div>
      ...
      <Modal modals={modals} setModals={setModals}>
        <h1 className="text-center text-xl font-bold pb-2">Skill Test</h1>

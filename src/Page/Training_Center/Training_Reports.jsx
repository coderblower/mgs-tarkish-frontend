...
const Training_Reports = () => {
  ...
  return (
    <div className="lg:mt-10 mt-2">
      ...
      {/* table  */}
      <div className="overflow-x-auto mt-10 lg:w-[90%] ">
        <table className="table ">
          ...
          <thead className=" border-b-2">
            <tr className="uppercase">
              ...
              <th>Exam</th>
              <th className="text-center">Skill type</th>
              <th className="flex justify-end">Exam Report</th>
            </tr>
          </thead>
          <tbody>
            {datas &&
              datas.map((item) => (
                <tr>
                  <th>245</th>
                  <th>Sadiq</th>
                  <th className="text-center">12/03/23</th>
                  <th>Pass</th>
                  <th className="text-center">Brigadier (Foreman) </th>
...
export default Training_Reports;
